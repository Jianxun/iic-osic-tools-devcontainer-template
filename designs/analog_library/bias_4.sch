...
N 470 -190 530 -190 {lab=#net1}
N 500 -250 500 -190 {lab=#net1}
N 430 -250 430 -220 {lab=#net2}
N 570 -420 600 -420 {lab=I_OUT}
N 350 -130 430 -130 {lab=VSS}
N 410 -420 430 -420 {lab=I_REF}
N 470 -310 530 -310 {lab=I_REF}
N 500 -370 500 -310 {lab=I_REF}
N 430 -370 500 -370 {lab=I_REF}
N 430 -370 430 -340 {lab=I_REF}
N 570 -420 570 -340 {lab=I_OUT}
N 430 -420 430 -370 {lab=I_REF}
N 430 -280 430 -250 {lab=#net2}
N 570 -280 570 -220 {lab=#net1}
N 500 -250 570 -250 {lab=#net1}
...
C {title.sym} 160 0 0 0 {name=l1 author="Jianxun Zhu"}
